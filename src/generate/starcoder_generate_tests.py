# src/generate/starcoder2_generate_tests.py
...
# If you want better instruction-following, consider: "bigcode/starcoder2-3b-instruct"
...
def main(
    ...
    # Some tokenizers don't have pad token set; use EOS as pad for generation
    ...
    # Pretty-print snapshots for easier inspection
    for temp in temperatures:
        records = []
        in_path = out_dir / f"StarCoder2-3B-Temperature-{temp}.jsonl"
        out_path = out_dir / f"StarCoder2-3B-Temperature-{temp}-pretty.json"
